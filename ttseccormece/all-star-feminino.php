...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/MtYQdKI.jpg" alt="" id="produtoImg2">
            </div>

            <div class="col-2">
                <h1>All Star Feminino</h1>
                <h4>R$ 70,00 </h4>
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('All Star Branco',70.00)">Adicionar ao
                        Carrinho</button>
    ...
    <div class="corpo-categorias-2">
        ...
        <div class="linha">
            ...
            <div class="col-4-1">
                <a href="qix-chorao.php"><img src="https://imgur.com/X7Q4Jv9.jpg" alt="" height="200"></a>
