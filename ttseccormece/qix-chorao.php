...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/X7Q4Jv9.jpg" alt="" id="produtoImg">
            </div>

            <div class="col-2">
                <h1>Tênis QIX Chorão 01</h1>
                <h4>R$ 150,90 </h4>
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Tênis QIX Chorão',150.90)">Adicionar ao
                        Carrinho</button>
