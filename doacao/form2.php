    ...
    <header class="header-1">
        <nav class="nav-bar">
            ...
            <div class="centered-text">
                <h1>VAMOS AJUDAR A ÁFRICA DO SUL</h1>
            </div>
        </nav>
    </header>
    ...
    <div class="container-principal">
        <div class="secao-doacoes">
            <div class="imagem-doacao">
                <img src="https://imgur.com/7NYIdPF.png" alt="Imagem de Doação" width="600" height="auto">
            </div>
            <div class="texto-doacao">
                <h1>Campanha de Solidariedade para Comunidades Vulneráveis na África do Sul</h1>

                <p>
                <h3>Objetivos:</h3>Objetivos incluem promover educação, saúde e segurança alimentar para melhorar o
                bem-estar comunitário através de doações direcionadas.
                </p>
                </br>

                <p>
                <h3>Para quem:</h3>Esta campanha é destinada às famílias de baixa renda, crianças, idosos e outros grupos vulneráveis
                na África do Sul, que enfrentam dificuldades significativas devido à pobreza e desigualdade social.
                </p>
                </br>

                <p>
                <h3>Local que irá a doação</h3>As doações serão direcionadas para comunidades urbanas e rurais em várias províncias
                da África do Sul, focando em áreas onde a necessidade é mais aguda. Parcerias com organizações locais serão
                fundamentais para garantir que os recursos alcancem aqueles que mais precisam.
                </p>
