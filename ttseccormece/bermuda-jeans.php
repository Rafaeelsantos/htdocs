...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/9fFeUxJ.png" alt="" id="produtoImg">
            </div>
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Bermuda Jeans',18.90)">Adicionar ao
                        Carrinho</button>
    ...
    <div class="corpo-categorias-2">
        ...
        <div class="linha">
            ...
            <div class="col-4-1">
                <a href="calca-moletom-nike.php"><img src="https://imgur.com/oc7kxIs.jpg" alt="" height="200"></a>
