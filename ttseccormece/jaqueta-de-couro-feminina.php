...
<head>
    ...
    <title>TTS (JAQUETA DE COURO)</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/msWYIen.jpg" alt="" id="produtoImg2">
            </div>
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Jaqueta de Couro',50.00)">Adicionar ao
                        Carrinho</button>
