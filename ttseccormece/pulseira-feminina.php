...
<head>
    ...
    <title>TTS (PULSEIRA FEMININA)</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/Mi9ZX3v.jpg" alt="" id="produtoImg2">
            </div>
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Pulseira Dourada',15.00)">Adicionar ao
                        Carrinho</button>
                ...
                <p>Pulseura Feminina Banhada a Ouro</p>
            </div>
