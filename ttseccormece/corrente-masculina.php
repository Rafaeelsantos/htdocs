...
<head>
    ...
    <title>TTS (CORRENTE MASCULINA)</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/wJRmhob.png" alt="" id="produtoImg">
            </div>
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                    ...
                    <select name="" id="">
                        ...
                        <option value="">11cm</option>
                        <option value="">14cm</option>
                    </select>
                    <br>

                    <button class="btn" onclick="adicionarAoCarrinho('Corrente Cravejada',25.00)">Adicionar ao
                        Carrinho</button>
                ...
                <p>Corrente Masculina Cravejada</p>
            </div>
    ...
    <div class="corpo-categorias-2">
        ...
        <div class="linha">
            ...
            <div class="col-4-1">
                <a href="relogio-de-ponteiro.php"><img src="https://imgur.com/eMDfSFm.jpg" alt="" height="200"></a>

                <a class="texto-link" href="relogio-de-ponteiro.php"><h4>Relógio de Ponteiro</h4></a>
