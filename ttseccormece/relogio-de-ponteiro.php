...
<head>
    ...
    <title>TTS (RELÓGIO DE PONTEIRO)</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/eMDfSFm.jpg" alt="" id="produtoImg">
            </div>
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Relógio de Ponteiro Masculino',20.00)">Adicionar ao
                        Carrinho</button>
    ...
    <div class="corpo-categorias-2">
        ...
        <div class="linha">
            ...
            <div class="col-4-1">
                <a href="pulseira-feminina.php"><img src="https://imgur.com/Mi9ZX3v.jpg" alt="" height="200"></a>
