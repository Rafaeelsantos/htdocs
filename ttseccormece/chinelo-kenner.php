...
<head>
    ...
    <title>TTS (CHINELO KENNER)</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/SG0H2ws.png" alt="" id="produtoImg2">
            </div>

            <div class="col-2">
                <h1>Chinelo Kenner</h1>
                <h4>R$ 50,00 </h4>
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Chinelo Kenner',50.00)">Adicionar ao
                        Carrinho</button>
    ...
    <div class="corpo-categorias-2">
        ...
        <div class="linha">
            ...
            <div class="col-4-1">
                <a href="all-star-feminino.php"><img src="https://imgur.com/MtYQdKI.jpg" alt="" height="200"></a>

                <a class="texto-link" href="all-star-feminino.php"><h4>All Star Feminino</h4></a>
