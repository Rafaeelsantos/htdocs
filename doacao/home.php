...
<!-------------------------------- FIM DA PRIMEIRA BARRA DE NAVEGAÇÃO -------------------------------->
    ...
    <section class="banner">
        <div class="banner-content">
            <div class="banner-text">
                ...
                <a href="campanhas.php"><button class="banner-button">Faça uma Doação</button></a>
            </div>
            <div class="banner-image">
                <img src="https://imgur.com/QTJY7Ss.png" alt="Imagem doação">
            </div>
        </div>
    </section>
    <!---------------------------------------- FIM DO BANNER ---------------------------------------------->
    ...
    <h2 class="categorias-texto">CAMPANHAS EM DESTAQUES</h2>
    ...
    <section class="categories">
        ...
        <div class="category">
            <div class="category-text">
                ...
                <a href="cadastro.php"><button class="category-button">Saiba mais</button></a>
            </div>
