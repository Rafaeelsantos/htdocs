...
<head>
    ...
    <title>TTS (JAQUETA DE BASEBALL)</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/HuJuDvW.jpg" alt="" id="produtoImg">
            </div>

            <div class="col-2">
                <h1>Jaqueta de Baseball</h1>
                <h4>R$ 39,90 </h4>
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Jaqueta de Baseball',39.90)">Adicionar ao
                        Carrinho</button>
