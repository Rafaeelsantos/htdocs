...
<head>
    ...
    <title>TTS (JAQUETA BOBOJACO)</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/qxJiCUT.png" alt="" id="produtoImg">
            </div>

            <div class="col-2">
                <h1>jaqueta Bobjaco</h1>
                <h4>R$ 50,00 </h4>
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Jaqueta Bobojaco', 50.00)">Adicionar ao
                        Carrinho</button>
    ...
    <div class="corpo-categorias-2">
        ...
        <div class="linha">
            ...
            <div class="col-4-1">
                <a href="jaqueta-de-couro-feminina.php"><img src="https://imgur.com/msWYIen.jpg" alt="" height="200"></a>

                <a class="texto-link" href="jaqueta-de-couro-feminina.php"><h4>Jaqueta de Couro</h4></a>
            ...
            <div class="col-4-1">
                <a href="jaqueta-de-baseball.php"><img src="https://imgur.com/HuJuDvW.jpg" alt=""  height="200"></a>

                <a class="texto-link" href="jaqueta-de-baseball.php"><h4>Jaqueta de Baseball</h4></a>
                <div class="classificacao">
                    <ion-icon name="star"></ion-icon>
                    <ion-icon name="star"></ion-icon>
                    <ion-icon name="star"></ion-icon>
