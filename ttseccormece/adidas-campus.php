...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/cd4X40V.png" alt="" id="produtoImg">
            </div>
            ...
            <div class="col-2">
                ...
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Adidas Campus',110.00)">Adicionar ao
                        Carrinho</button>
