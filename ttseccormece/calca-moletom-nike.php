...
<head>
    ...
    <title>TTS (CALÇA MOLETOM NIKE)</title>
...
<body>
    ...
    <div class="corpo-categorias ver-produto">
        <div class="linha">
            ...
            <div class="col-2">
                <img src="https://imgur.com/oc7kxIs.jpg" alt="" id="produtoImg">
            </div>

            <div class="col-2">
                <h1>Calça Moletom Nike</h1>
                <h4>R$ 29,90 </h4>
                <form action="" method="post">
                    ...
                    <button class="btn" onclick="adicionarAoCarrinho('Calça Moleotm nike',29.90)">Adicionar ao
                        Carrinho</button>
    ...
    <div class="corpo-categorias-2">
        ...
        <div class="linha">
            ...
            <div class="col-4-1">
                <a href="calca-wid-leg.php"><img src="https://imgur.com/FT5U85R.jpg" alt="" height="200"></a>
