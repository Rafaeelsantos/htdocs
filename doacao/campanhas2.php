...
<header class="header-2">
    <nav class="nav-bar-2">
        <div class="nav-list">
            <ul>
                <li class="nav-item"><a href="home2.php" class="nav-link">Início</a></li>
    ...
    <div class="category">
        <div class="category-text">
            ...
            <p>Contribua para melhorar as condições de vida das comunidades na África do Sul.</p>
                <a href="form2.php"><button class="category-button">Acessar</button></a>
    ...
    <div class="category">
        <div class="category-text">
            ...
            <p>Participe da campanha de doação de sangue e salve vidas.</p>
                <a href="form3.php"><button class="category-button">Acessar</button></a>
